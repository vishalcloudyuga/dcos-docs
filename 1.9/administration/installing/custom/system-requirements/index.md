...
$ timedatectl
```
Although it is not recommended, you can disable the startup check for NTP by setting the `check_time: 'false'` in the [configuration file](/docs/1.9/administration/installing/custom/configuration-parameters/#check-time).
