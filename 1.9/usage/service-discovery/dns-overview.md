 ...
 * Port Name: `myport`
 * Load Balanced
* Running on a [Virtual Network](/docs/1.9/usage/service-discovery/load-balancing-vips/overlay-networks/)
 ...
 * This is only available when the service is running on a [virtual network](/docs/1.9/usage/service-discovery/load-balancing-vips/overlay-networks/).
1.  `myapp-subgroup-outergroup.marathon.agentip.dcos.thisdcos.directory`
 * This is always available and should be used when the service is not running on a [virtual network](/docs/1.9/usage/service-discovery/load-balancing-vips/overlay-networks/).
1.  `myapp-subgroup-outergroup.marathon.autoip.dcos.thisdcos.directory`
 * This is always available and should be used to address an application that is transitioning on or off a [virtual network](/docs/1.9/usage/service-discovery/load-balancing-vips/overlay-networks/).
