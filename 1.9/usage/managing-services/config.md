...
This topic describes how to use the DC/OS CLI to configure services. You can also customize services by using the [**Services**](/docs/1.9/usage/webinterface/#services) tab in the DC/OS UI. 
...
For more information, see the [dcos package](/docs/1.9/usage/cli/command-reference/#dcospackage) documentation.
