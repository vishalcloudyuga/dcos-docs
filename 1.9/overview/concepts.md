...
The node where a custom DC/OS installation is run. For more information, see the [system requirements](/docs/1.9/administration/installing/custom/system-requirements/#bootstrap-node).
...
Public agent nodes run DC/OS apps and services in a publicly accessible network. DC/OS agent nodes can be designated as [public][2] or [private][1] during installation. For more information see:
 ...
 - [Network Security][11]
 - [Creating a public agent node](/docs/1.9/administration/installing/custom/convert-agent-type/)
...
[1]: #private
[2]: #public
[3]: /docs/1.9/administration/installing/cloud/
...
[11]: /docs/1.9/administration/securing-your-cluster/
