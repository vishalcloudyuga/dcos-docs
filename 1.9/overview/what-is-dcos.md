...
Unlike Linux, DC/OS is not a [host operating system](/docs/1.8/overview/concepts/#host-operating-system). DC/OS spans multiple machines, but relies on each machine to have its own host operating system and host kernel.
