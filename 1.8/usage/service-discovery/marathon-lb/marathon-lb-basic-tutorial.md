...
### Prerequisites
- [A DC/OS cluster](/docs/1.8/administration/installing/) with at least one [private](https://dcos.io/docs/1.8/overview/concepts/#private) agent and one [public](/docs/1.8/overview/concepts/#public) agent.
