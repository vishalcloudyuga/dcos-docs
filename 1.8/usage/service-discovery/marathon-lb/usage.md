...
1.  Install Marathon-LB.
    ...
    To check that Marathon-LB is working, [find the IP for your public node](/docs/1.8/administration/locate-public-agent/) and navigate to `http://<public agent ip>:9090/haproxy?stats`. You will see a statistics report page like this:
